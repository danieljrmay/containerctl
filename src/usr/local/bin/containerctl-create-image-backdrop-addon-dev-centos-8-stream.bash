#!/usr/bin/env bash
# containerctl-create-image-backdrop-addon-dev-centos-8-stream
#
# Author: Daniel J. R. May
#
# This script creates a container image of backdrop, httpd, mariadb
# and various php libraries on a CentOS 8 stream base.
#
...
if source "$lib_path"; then
	info 'Started containerctl-create-image-backdrop-addon-dev-centos-8-stream script'
...
verbose "Pull the latest version of CentOS Stream 8"
